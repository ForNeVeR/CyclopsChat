...
public partial class ApplicationSettings : ViewModelBase, ICloneable
{
    ...
    private static readonly Serializer<ApplicationSettings> Serializer = new();
    private const string ConfigFilePath = @"Data\Profiles\Application.config.xml";

    private static void Save(ApplicationSettings obj)
    {
